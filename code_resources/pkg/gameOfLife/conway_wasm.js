...
/**
 * Game of Life universe exposed to JavaScript.
 */
export class Universe {
     ...
     * @param {number} width
     * @param {number} height
     * @param {number} alive_probability
     * @returns {Universe}
     */
    static random(width, height, alive_probability) {
        const ret = wasm.universe_random(width, height, alive_probability);
        return Universe.__wrap(ret);
    }
    /**
     * @returns {number}
     ...
     */
    cells_len() {
        const ret = wasm.universe_cells_len(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    ...
    set_cell(row, col, alive) {
        wasm.universe_set_cell(this.__wbg_ptr, row, col, alive);
    }
    /**
    ...
    randomize(alive_probability) {
        wasm.universe_randomize(this.__wbg_ptr, alive_probability);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('conway_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
